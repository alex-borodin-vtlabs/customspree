module Spree
  module Api
    module ApiHelpers
      ...
      @@variant_attributes = [
        :id, :name, :sku, :product_type, :is_rentable, :price, :weight, :height, :width, :depth, :is_master,
      ...
      @@order_attributes = [
        ...
        :display_additional_tax_total, :tax_total, :currency, :rental_start_date, 
        :rental_end_date, :zipcode, :stock_location_id
      ]
      ...
      @@creditcard_attributes = [
        ...
        :gateway_customer_profile_id, :gateway_payment_profile_id, :default
      ]
