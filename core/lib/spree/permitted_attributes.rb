module Spree
  module PermittedAttributes
    ...
    @@checkout_attributes = [
      :coupon_code, :email, :shipping_method_id, :special_instructions, :use_billing, :use_shipping, :rental_start_date, :rental_end_date, :zipcode
    ]
    ...
    @@shipment_attributes = [
      :order, :special_instructions, :stock_location_id, :id, :state,
