        ...
        klass.class_eval do
          ...
          def self.define_state_machine!
            ...
            state_machine :state, initial: :cart, use_transactions: false, action: :save_state do
              ...
              if states[:payment]
                transition = Spree::Config[:always_include_confirm_step] ? { to: :confirm } : { to: :complete }

                before_transition transition do |order|
                ...
                after_transition to: :payment, do: :attempt_auto_transition_to_confirm
              end
              ...
              if states[:delivery]
                ...
                after_transition to: :delivery, do: :set_default_shipping_method_and_stock_location
              end
              ...
              before_transition to: :confirm, do: :ensure_user_has_logged_in
            end
