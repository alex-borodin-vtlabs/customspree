module Spree
  module Admin
    class OrdersController < Spree::Admin::BaseController
      ...
      before_action :load_order, only: [:edit, :update, :cancel, :resume, :approve, :resend, :resend_return_reminder, :open_adjustments, :close_adjustments, :cart]
      ...
      def resend_return_reminder
        OrderMailer.rental_return_reminder_email(@order.id).deliver_later
        flash[:success] = Spree.t(:return_reminder_email_resent)
        redirect_to :back
      end
